...
def build_url_output(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    update_notable_results_found(container=container)
...
def url_result_filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    if matched_artifacts_2 or matched_results_2:
        update_notable_no_results(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_2, filtered_results=matched_results_2)
...
@phantom.playbook_block()
def update_notable_results_found(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("update_notable_results_found() called")
    ...
    # build parameters list for 'update_notable_results_found' call
    ...
    phantom.act("update event", parameters=parameters, name="update_notable_results_found", assets=["splunkes"], callback=add_note_1)

    return


@phantom.playbook_block()
def update_notable_no_results(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("update_notable_no_results() called")
    ...
    # build parameters list for 'update_notable_no_results' call
    for container_artifact_item in container_artifact_data:
        if container_artifact_item[0] is not None:
            parameters.append({
    ...
    phantom.act("update event", parameters=parameters, name="update_notable_no_results", assets=["splunkes"])
